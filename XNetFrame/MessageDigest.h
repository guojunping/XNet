///////////////////////////////////////
// Author : Mr Kim
// Name : Generate MD5 Key, and encrypt the message
///////////////////////////////////////
...
struct MD5_STATE{ //  
    sint32 m_siAbcd[4];
    sint32 m_siCount[2];
    uchar8 m_szBuffer[64];
};

class CMessageDigest{
private:
	MD5_STATE m_msMd5_State; //  
...
public:
	CMessageDigest(void);
	virtual ~CMessageDigest(void);

	void reset(void);             //  
	void digest(uchar8*);         // 
	void update(uchar8*, sint32); // 
};
